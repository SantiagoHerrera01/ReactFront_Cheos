...
function KpiCard({ icon: Icon, label, value, sub, iconBg, iconColor, valueClass }) {
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-5 flex flex-col gap-1 hover:border-gray-300 hover:shadow-sm transition-all">
      ...
      <p className={`font-display font-bold text-xl sm:text-2xl leading-tight ${valueClass}`}>{value}</p>
      ...
      {top_products?.length > 0 && (
        <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-5 shadow-sm">
          <div className="flex items-center gap-3 mb-4 sm:mb-5">
            <h3 className="font-display font-bold text-sm sm:text-base text-gray-900">Productos más vendidos</h3>
